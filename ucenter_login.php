...
//基础config
define('CLIENT_ID', 'UC57971433ca313');//应用ID，需要申请
define('CLIENT_SECRET', '5eafe65a838032589f8983077cb70e81');//应用密钥，需要申请
define('REDIRECT_URI', 'http://phpmyadmin.szjlxh.com/ucenter_login.php');//回调地址
